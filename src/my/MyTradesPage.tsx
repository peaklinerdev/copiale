        ...
        <CardContent className="p-6">
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-muted mb-4">You don't have any trades yet.</p>
            ...
            <>
              ...
              <div className="md:hidden space-y-4">
                {myTrades.map(trade => (
                  <div
                    key={trade.public_id || trade.id}
                    className="border border-neutral-200 rounded-lg p-4 hover:bg-[#2b3139]"
                  >
                    <div className="flex justify-between items-start mb-3">
                      <div className="font-medium">{formatDisplayId(trade.public_id || trade.id)}</div>
                      <span
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="mt-4 space-y-2">
                        ...
                        >
                          <Link to={`/trade/${trade.public_id || trade.id}`} className="w-full block">
                            Details
                          </Link>
                        </Button>
                      </div>
              ...
              <div className="hidden md:block overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {myTrades.map(trade => (
                      <TableRow key={trade.public_id || trade.id} className="hover:bg-[#2b3139]">
                        <TableCell className="font-medium">{formatDisplayId(trade.public_id || trade.id)}</TableCell>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                            ...
                            >
                              <Link to={`/trade/${trade.public_id || trade.id}`}>Details</Link>
                            </Button>
                          </div>
                        </TableCell>
                      </TableRow>
