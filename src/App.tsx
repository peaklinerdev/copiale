...
const COTCPage = lazy(() => import('./pages/OTCPage'));
const COTCViewPage = lazy(() => import('./pages/OTCViewPage'));
            ...
            <ErrorBoundary>
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route path="/cotc" element={<COTCPage />} />
                  <Route path="/cotc/:id" element={<COTCViewPage />} />
